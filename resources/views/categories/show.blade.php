<x-layout>
  <x-slot name="title">{{__('ui.categoria')}} {{__('ui.' . $name)}}</x-slot>
...
<div class="row justify-content-center">
    ...
    <div class="row px-5 justify-content-baseline" style="padding: 150px 0px">
      ...
      <h2 class="fw-bold text-center mb-5">{{__('ui.annunci_categoria')}} <span class="text-main">{{__('ui.' . $name)}}</span></h2>
      ...
      <div class="col-md-3 col-12 mt-5">
        ...
        <div class="card mb-3 h-100">
          ...
          <div class="card-body">
            ...
            {{-- @auth
            <a href="#" class="btn bg-success text-white">Modifica</a>
            @endauth --}}
          </div>
        </div>
